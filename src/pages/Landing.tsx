...
const { 
  ...
  FiUsers, FiCalendar, FiBarChart2, FiStar, FiArrowRight,
  FiCheck, FiPlay, FiGithub, FiLinkedin, FiMail, FiShield,
  FiClock, FiDatabase, FiSmartphone, FiSun, FiMoon
} = FiIcons;
...
const Landing: React.FC = () => {
  ...
  const stats = [
    { number: '10,000+', label: 'Problems Tracked', icon: FiCode },
    { number: '500+', label: 'Companies Covered', icon: FiUsers },
    { number: '24/7', label: 'Real-time Sync', icon: FiCalendar },
    { number: '99.9%', label: 'Uptime', icon: FiStar }
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            >
              <button
                onClick={() => handleGetStarted('signup')}
                className="px-8 py-4 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors font-semibold flex items-center space-x-2 text-lg shadow-lg"
              >
            ...
            >
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                <div className="bg-gray-100 dark:bg-gray-700 px-6 py-4 flex items-center space-x-3">
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400 font-medium">DSA Tracker Dashboard</div>
                </div>
                <div className="p-8">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div className="bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 p-6 rounded-xl">
                      <div className="flex items-center space-x-3 mb-3">
                        <SafeIcon icon={FiTarget} className="w-6 h-6 text-blue-600 dark:text-blue-400" />
                        <span className="font-semibold text-blue-700 dark:text-blue-300">Daily Goal</span>
                      </div>
                      <div className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-1">4/5</div>
                      <div className="text-sm text-blue-500 dark:text-blue-400">Problems solved today</div>
                    </div>
                    <div className="bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 p-6 rounded-xl">
                      <div className="flex items-center space-x-3 mb-3">
                        <SafeIcon icon={FiZap} className="w-6 h-6 text-green-600 dark:text-green-400" />
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="text-xs text-gray-500 dark:text-gray-400">85% complete</span>
                    </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary-600 to-purple-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <button
              onClick={() => handleGetStarted('signup')}
              className="px-8 py-4 bg-white text-primary-600 rounded-lg hover:bg-gray-100 transition-colors font-semibold text-lg flex items-center space-x-2 mx-auto shadow-lg"
            >
