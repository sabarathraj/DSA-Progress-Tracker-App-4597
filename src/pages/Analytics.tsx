...
const { FiBarChart2, FiTrendingUp, FiTarget, FiZap } = FiIcons;

const Analytics: React.FC = () => {
  const { problems, getStats, loadAllData, hasLoadedOnce } = useDSA();
  ...
  if (!hasLoadedOnce) {
    return <div className="min-h-screen flex items-center justify-center"><LoadingSpinner fullScreen message="Loading analytics..." /></div>;
  }
  ...
  if (!problems.length) {
    return (
      <EmptyState
        ...
        description="Solve some problems to see your progress and analytics here!"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <div className="p-2 bg-primary-100 dark:bg-primary-900 rounded-lg">
            <SafeIcon icon={FiBarChart2} className="w-6 h-6 text-primary-600 dark:text-primary-400" />
          </div>
          <div>
