...
const { FiAward, FiStar, FiCalendar } = FiIcons;
    ...
    >
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="p-2 bg-orange-100 dark:bg-orange-900 rounded-lg">
          <SafeIcon icon={FiAward} className="w-5 h-5 text-orange-600 dark:text-orange-400" />
        </div>
      </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
          <div className="flex items-center space-x-3">
            <SafeIcon icon={FiStar} className="w-5 h-5 text-warning-500" />
        ...
        <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
          ...
          <span className={`text-sm font-medium px-2 py-1 rounded-full ${
            ...
            {safeTodayProgress.achieved ? '✅ Complete' : '⏳ Pending'}
          </span>
        </div>
      </div>
