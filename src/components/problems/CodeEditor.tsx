...
import { useDSA, CodeSnippet } from '../../context/DSAContext';
...
const CodeEditor: React.FC<CodeEditorProps> = ({ problemId, snippets, onSnippetSaved }) => {
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  value={String(newSnippet.is_solution)}
            ...
            <div className="flex items-center space-x-2">
              <Button
                ...
                leftIcon={<SafeIcon icon={FiSave} className="w-4 h-4" />}
              >
                Save
              </Button>
              <Button
