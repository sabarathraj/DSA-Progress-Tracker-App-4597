...
const { FiFire, FiTrendingUp, FiCalendar } = FiIcons;
  ...
  return (
    ...
    >
      ...
      <div className="mt-6 grid grid-cols-3 gap-4">
        <div className="text-center p-4 bg-gradient-to-r from-orange-50 to-orange-100 dark:from-orange-900 dark:to-orange-800 rounded-lg">
          <div className="flex items-center justify-center mb-2">
            <SafeIcon icon={FiFire} className="w-6 h-6 text-orange-600 dark:text-orange-400" />
          </div>
        ...
        <div className="text-center p-4 bg-gradient-to-r from-primary-50 to-primary-100 dark:from-primary-900 dark:to-primary-800 rounded-lg">
          <div className="flex items-center justify-center mb-2">
        ...
        <div className="text-center p-4 bg-gradient-to-r from-success-50 to-success-100 dark:from-success-900 dark:to-success-800 rounded-lg">
          <div className="flex items-center justify-center mb-2">
