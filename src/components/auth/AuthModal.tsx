...
const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose, initialMode = 'signin' }) => {
  ...
  const { signIn, signUp, signInWithGoogle, authLoading } = useAuth() as {
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              {mode === 'signup' && (
                <div>
                  ...
                  <Input
                      {...register('fullName')}
                      type="text"
                    leftIcon={<SafeIcon icon={FiUser} className="w-5 h-5 text-gray-400" />}
              ...
              <div>
                ...
                <Input
                    {...register('email')}
                    type="email"
                  leftIcon={<SafeIcon icon={FiMail} className="w-5 h-5 text-gray-400" />}
              ...
              <div>
                ...
                <Input
                  ...
                  leftIcon={<SafeIcon icon={FiLock} className="w-5 h-5 text-gray-400" />}
                  rightIcon={
                  <button
                    type="button"
              ...
              {mode === 'signup' && (
                <div>
                  ...
                  error={typeof errors.confirmPassword?.message === 'string' ? errors.confirmPassword.message : undefined}
